...
//        String resourceCode = map.code ?: map.error
//        resourceCode = resourceCode ?: "default.unknown.banner.api.exception" // as a last resort, we'll use a very generic message...
//
//        return getMessage( resourceCode, map.args )
